...
@FilterDefs(value = {@FilterDef(name=MaeOperacion.F_ID_OPERACION, parameters = { @ParamDef(name="idOperacion", type="int") }),
					@FilterDef(name=MaeOperacion.F_ENDPOINT_OPERACION, parameters = {@ParamDef(name="endpoint", type="string")}),
					@FilterDef(name=MaeOperacion.F_ID_OPERACION_NO, parameters = { @ParamDef(name="idOperacion", type="int") })})
@Filters(value = {@Filter(name = MaeOperacion.F_ID_OPERACION, condition = "N_OPERACION=:idOperacion"),
					@Filter(name= MaeOperacion.F_ENDPOINT_OPERACION, condition = "X_ENDPOINT=:endpoint"),
					@Filter(name = MaeOperacion.F_ID_OPERACION_NO, condition = "N_OPERACION!=:idOperacion"),})
...
public class MaeOperacion extends Auditoria implements Serializable{/**
	...
	public static final String F_ID_OPERACION_NO = "MaeOperacion.filterIdOperacionNo";
	public static final String F_ENDPOINT_OPERACION = "MaeOperacion.filterEndpointOperacion";
